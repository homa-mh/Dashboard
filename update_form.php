...
$repairProducts = $ctrl->get_products_by_category('update');
?>
...
<div class="main container mx-auto p-4">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <h1 class="text-2xl font-bold" style="margin:auto;"> به روزرسانی دستگاه</h1>
    </div>
    <p class="text-center mb-6">لطفا پس از پر کردن فرم زیر، نسبت به پرداخت هزینه اقدام فرمائید.</p>
    <p class="text-center mb-4">پس از پرداخت هزینه درخواست شما ثبت خواهد شد.</p>

    <div class="flex justify-center mb-6">
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSeNIKd9Sc4_KruvCG-i9BGyazjqqMuDPrK-cTNMXfxDmHQhlQ/viewform?usp=header"
           class="bg-teal-600 hover:bg-teal-500 text-white py-2 px-4 rounded transition">
           فرم درخواست آپدیت دستگاه
        </a>
    </div>
